...
const SearchInput: React.FC<SearchInputProps> = ({
  ...
  return (
    <div className="mt-6 relative bg-white dark:bg-[rgb(43,57,69)] dark:shadow-md dark:text-white shadow-[0_7px_29px_0_rgba(100,100,111,.2)] rounded-[4px] transition-all duration-[1000ms] ease-in-out sm:w-[300px] md:w-[400px] lg:w-[480px] h-[50px]">
